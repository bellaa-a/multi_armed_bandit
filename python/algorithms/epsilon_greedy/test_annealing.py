...
def run_annealing_epsilon(seed=1, num_sim=10, horizon=500, num_arms=5):
    random.seed(seed)
    ...
    with open("algorithms/epsilon_greedy/annealing_regret.csv", "w") as f_summary, \
         open("algorithms/epsilon_greedy/annealing_results.csv", "w") as f_detail:
...
run_annealing_epsilon(1, 10, 500)