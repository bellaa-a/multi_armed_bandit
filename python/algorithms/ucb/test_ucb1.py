# continuous exploration every round
import sys
...
def run_ucb1(seed=1, num_sim=10, horizon=500, num_arms=5, arm_type="bernoulli"):
    random.seed(seed)
    ...
    with open("algorithms/ucb/ucb1_results.csv", "w") as f_detail, \
         open("algorithms/ucb/ucb1_regret.csv", "w") as f_summary:
